...
if USE_SIMULATION:
    from .service.firebase_service import simulator
...
def get_garden_weather(garden_id: str) -> Dict[str, Any]:
    ...
    try:
        ...
        from irrigation_agent.service.weather_service import get_weather_for_garden
...
def get_irrigation_recommendation_with_weather(garden_id: str, plant_id: str) -> Dict[str, Any]:
    ...
    try:
        ...
        from irrigation_agent.service.weather_service import get_irrigation_recommendation
